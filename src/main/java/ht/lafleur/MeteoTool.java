...
//            System.out.println("Réponse de l'API météo : " + response);
    ...
    @Tool("Retourne la latitude et la longitude d'une ville à partir de son nom. " +
            "Utiliser le format 'Ville,Pays' en anglais pour lever une ambiguïté (ex: 'Rabat,Morocco'). " +
            "Retourne un tableau de deux doubles : [latitude, longitude].")
    public double[] getCoordonnees(@P("Nom de la ville, en anglais si possible. " +
                                    "Format 'Ville,Pays' pour les villes ambiguës (ex: 'Paris,France', 'Rabat,Morocco').")
                                       String ville) {
        try {
